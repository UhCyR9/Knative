...
## Wnioski
Projekt demonstruje, że Knative jest efektywnym narzędziem do zarządzania aplikacjami kontenerowymi w środowisku Kubernetes, zapewniającym wiele kluczowych funkcji wspierających skalowalność i elastyczność aplikacji. Dzięki możliwości dynamicznego skalowania, Knative pozwala na dostosowanie liczby instancji serwisów do aktualnego zapotrzebowania, co jest szczególnie ważne w przypadku aplikacji o zmiennym obciążeniu. Ta funkcjonalność przyczynia się do optymalizacji zużycia zasobów, co może przekładać się na obniżenie kosztów operacyjnych. \
Funkcjonalności takie jak traffic splitting pozwalają na płynne przechodzenie między różnymi wersjami aplikacji, co ułatwia wdrażanie nowych wersji aplikacji. Pozwala to na stopniowe przekierowywanie ruchu na nowe wersje, co minimalizuje ryzyko związane z wprowadzaniem zmian i pozwala na bardziej kontrolowane wdrażanie aktualizacji. \
Integracja z systemami eventowymi umożliwia Knative automatyzację reakcji na zdarzenia wewnętrzne i zewnętrzne, co zwiększa efektywność aplikacji poprzez możliwość szybkiego reagowania na zmieniające się warunki czy potrzeby biznesowe. Implementacja serwisów przetwarzających obrazy oraz monitorowanie ich działania za pomocą Prometheus i Grafana pokazuje, jak łatwo można monitorować i optymalizować wydajność aplikacji. Całość demonstruje, że dzięki Knative można z łatwością zarządzać złożonymi aplikacjami, zwiększając ich skalowalność, niezawodność i elastyczność. \
Podsumowując, Knative oferuje kompleksowe narzędzie do zarządzania nowoczesnymi aplikacjami kontenerowymi, które są rozproszone i działają w dynamicznie zmieniającym się środowisku. Dzięki funkcjom takim jak dynamiczne skalowanie, zaawansowane zarządzanie ruchem i integracja z systemami eventowymi, Knative znacząco ułatwia rozwój, wdrażanie i zarządzanie aplikacjami, podnosząc ich niezawodność, skalowalność oraz ogólną wydajność.
